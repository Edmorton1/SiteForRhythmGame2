import { DatabaseService } from "../../common/services/db/postgres/database.service";
import bcrypt from "bcrypt";
import { AuthDTO } from "../../common/models/schemas/auth.dto";
import { DatabaseKysely } from "../../common/services/db/postgres/database.type";
...
export class AuthSQL {
	...
	registration = async (authDTO: AuthDTO) => {
